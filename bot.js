...
client.on("message", message => {
    ...
    if (message.content.startsWith(`${prefix}${helpCommand}`)) {
        message.channel.sendMessage("Sorry, but my creator has yet to implement a help feature. I suggest forming an angry mob and storming " + ((botCreatorMember == null) ? "Alex P" : botCreatorMember.user) + "'s castle.");
    }
